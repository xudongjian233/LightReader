...
public class ScreenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * App.sContext.getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / App.sContext.getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / App.sContext.getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * App.sContext.getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = App.sContext.getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = App.sContext.getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
...
//            sbar = App.sContext.getResources().getDimensionPixelSize(x);
//        } catch (Exception e1) {
//            e1.printStackTrace();
//        }
//        return sbar;
